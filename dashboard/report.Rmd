...
# define two functions to convert the data form to edgelist
# functions are adapted from https://github.com/MOO-VIS/Peek-a-Moo
...
We use Markov Chain Monte Carlo(MCMC) with the parameters: chain = 1, iter = 12000, warmup = 2000, thin = 10 to simulate 1000 samples.
...
# check the convergence of the simulations
...
# plot all the 95% credible intervals
